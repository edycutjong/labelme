...
| Tests | **111 tests** (vitest) · **12,000 generated cases** (fast-check) · **10,000 generated malformed ids** rejected before any network call · 32 Playwright runs (16 tests × desktop + Pixel 7) on a built app with no key |
| Clean clone → first output | **7 s** to the first round, **11 s** through verify and the 111 tests (clone 2 s · install 5 s · round < 1 s · verify 1 s · tests 3 s; re-measured 2026-09-19; 6 s / 9 s on 2026-09-18) |

...
export { CLASS_INFO, PRECEDENCE, STRUCTURAL_TAG, WEALTH_TAG, ACTIVITY_TAG, ENS_TAG, ENTITY_TAG, counterpartyClass, classFromTag, classFromEntity, tagIsNeutral, resolveClass, POOL_TAG, EXCHANGE_MARK } from "./classes.js";

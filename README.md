...
[![Live Demo](https://img.shields.io/badge/🚀_Live-Demo-06b6d4?style=for-the-badge)](https://labelme-edycutjong.vercel.app)
[![For Judges](https://img.shields.io/badge/⚖️_For-Judges-22c55e?style=for-the-badge)](https://labelme-edycutjong.vercel.app/judge)
...
![tests](https://img.shields.io/badge/tests-96%20passing-22c55e?style=flat)
...
| **Tests** | **96 tests** (vitest) · **12,000 property cases** (fast-check: the reader is total over any clues, the tell is one line, the hash ignores time and the reader, a round is deterministic and URL-safe, extractors never throw) · a route boundary suite: garbage never reaches Nansen |
...
Clone + install + first round: **6 s** of machine time; with `verify` and the 96 tests **9 s** (timed clean clone from GitHub, 2026-09-18 — clone 1 s · install 4 s · first round 1 s · verify < 1 s · tests 3 s).

## 🧪 Testing & CI

```bash
npm test                 # 96 vitest tests, no key, no network (≈ 4 s)
